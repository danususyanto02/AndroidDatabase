...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    public static final String URLTAMPIL = "http://192.168.100.62/pbmdatabase/view.php";
    public static final String URLDELETE = "http://192.168.100.62/pbmdatabase/delete.php";
    public static final String URLINSERT = "http://192.168.100.62/pbmdatabase/create.php";
    public static final String URLUBAH   = "http://192.168.100.62/pbmdatabase/edit.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                final CharSequence[] dialogitem = {"Ubah", "Delete"};
